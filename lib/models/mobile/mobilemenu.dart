    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            userName == null ? Space.emptySpace : profile(modelProvider),
            //userName == null ? Space.emptySpace : loginLogoutButton(modelProvider),
            term(context),
          ],
        ),
      ),
      ...
      borderRadius: BorderRadius.circular(20),
            ...
            child: MouseRegion(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    Icon(user == null ? Icons.login : Icons.logout, color: loginLogoutButtonHover ? ProjectColors.customColor : ProjectColors.greyColor, size: 20),
                    Space.mWidth,
                    ProjectText.rText(

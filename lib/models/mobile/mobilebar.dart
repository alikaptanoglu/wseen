...
class _MobileBarState extends State<MobileBar> with SingleTickerProviderStateMixin {
  ...
  Widget _buildHomeBar(ModelProvider modelProvider) {
    return Container(
        ...
        decoration: const BoxDecoration(gradient: LinearGradient(colors: [Color.fromARGB(255, 60, 60, 60), Color.fromARGB(255, 20, 20, 20), Color.fromARGB(255, 0, 0, 0)], begin: Alignment.topCenter, end: Alignment.bottomCenter), border: Border(bottom: BorderSide(color: Color.fromARGB(255, 140, 140, 140), width: 0.5))),
        child: Row(

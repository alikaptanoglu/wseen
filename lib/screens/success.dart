                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: const BoxDecoration(shape: BoxShape.circle, gradient: LinearGradient(colors: [Color.fromARGB(255, 12, 202, 177), Color.fromARGB(255, 32, 214, 153)], begin: Alignment.topLeft, end: Alignment.bottomRight)),
                                  child: const Icon(Icons.check, color: Colors.white, size: 30),
                                ),
                                Space.spaceHeight(10),
                                GradientText('Payment Successful!', gradient: const LinearGradient(colors: [Color.fromARGB(255, 12, 202, 177), Color.fromARGB(255, 32, 214, 153)], begin: Alignment.centerLeft, end: Alignment.centerRight), style: GoogleFonts.poppins(fontSize: SizeConfig.screenWidth! < 350 ? 18 : SizeConfig.screenWidth! < 400 ? 20 : SizeConfig.screenWidth! < 600 ? 23  : 26, fontWeight: FontWeight.bold)),
                                Space.spaceHeight(10),
                                Text('Transaction Number: 1234534632134', style: GoogleFonts.poppins(fontSize: SizeConfig.screenWidth! < 350 ? 11 : SizeConfig.screenWidth! < 400 ? 12 : SizeConfig.screenWidth! < 600 ? 13  : 14, color: Colors.black26, fontWeight: FontWeight.bold)),
                              ],
                            ),
                          ),
                          _dottedLine(),
